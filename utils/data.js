...
const usersData = [
    {
        ...
        email: 'poncho@me.com',
        thoughts: [],
        friends: ['665989eea2a1b376f190e998','665989eea2a1b376f190e997']
    },
    {
        username: 'milad',
        email: 'milad@me.com',
...
async function seed() {
    try {
        ...
        await Reaction.deleteMany(); // Elimina todas las reacciones antes de insertar nuevas

        // Insert new data
        const createdUsers = await User.create(usersData);
        const createdThoughts = await Thought.create(thoughtsData);
        const createdReactions = await Reaction.create(reactionsData); // Crea las reacciones
